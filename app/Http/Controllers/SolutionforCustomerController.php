...
class SolutionforCustomerController extends Controller
{
 /**
    ...
    public function index(Request $request, Solution $contact): View
    {
        ...
        $solution = Solution::where('id', Solution::min('id'))->first()->toArray();;
        // Kiểm tra nếu solution tồn tại

        $solutionSubset = array_slice($solution, 7, 20);
